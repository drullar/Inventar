...
fun EditProductCard(
    ...
    LaunchedEffect(productData) {
        nameField = productData.name
        sellingPriceField = productData.sellingPrice.toString()
        providerPriceField = productData.providerPrice?.toString() ?: ""
        availableQuantityField = productData.availableQuantity.toString()
        barcodeField = productData.barcode ?: ""
        sellingPriceFieldWarning = null
        availableQuantityFieldWarning = null
    }
